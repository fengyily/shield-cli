...
// 检查 shield-cli 是否安装
async function checkShieldCli(): Promise<boolean> {
...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand('shield.startService', startShieldService),
    vscode.commands.registerCommand('shield.stopService', stopShieldService),
    vscode.commands.registerCommand('shield.openWebUI', openShieldWebUI),
    vscode.commands.registerCommand('shield.connectSSH', connectSSH),
    vscode.commands.registerCommand('shield.connectRDP', connectRDP),
    vscode.commands.registerCommand('shield.connectHTTP', connectHTTP)
  );

  // 创建侧边栏
  const sidebarProvider = new ShieldSidebarProvider(context.extensionUri);
  context.subscriptions.push(
    vscode.window.registerWebviewViewProvider('shield-sidebar', sidebarProvider)
  );
}
...
// 侧边栏提供器
class ShieldSidebarProvider implements vscode.WebviewViewProvider {
